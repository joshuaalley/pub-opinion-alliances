...
Because U.S. political parties are big-tent organizations that often contain divergent foreign policy visions, elite cues may only move particular wings.\footnote{See \citet{Dueck2019} for one history of competing foreign policy visions in the Republican Party.}
...
Democrats express higher support for alliances like NATO than Republicans \citep{PewNATO2020}.
This partisan gap in alliance attitudes is smaller than polarized issues like the Iran nuclear program, yet larger than more technical issues such as the International Criminal Court \citet{GuisingerSaunders2017}. 
