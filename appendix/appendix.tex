...
\section{Conjoint Table Example and Outcome Questions}

Here, \autoref{fig:example-conjoint} presents an example alliance conjoint table from the alliance maintenance experiment, along with the yes/no and rating questions.

\begin{figure}[htbp]
	\centering
		\includegraphics[height=0.90\textheight]{example-conjoint.pdf}
	\caption{Example alliance conjoint table and outcome questions.}
	\label{fig:example-conjoint}
\end{figure}
